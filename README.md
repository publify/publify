...
Heroku may also needs the ruby version to be declared, you may add
...
-   page_header withh display a page header generated by Typo. It will
    provide:
...
Every `div` included here are not mandatory. You just need to care about
the ruby calls.
...
people to comment your wine reviews (this to make the sample template
...
Create 2 custom templates: one to display wine related articles, and one
to display the Wine category.

First, create a templates called `wine.html.erb` in your
...
Here you are, you can now write about wine. Just don’t forget to chose
...
like this, pretty like normal admin controller:
