...
class BaseConverter
  ...
  #     # build Publify User object from other user
  #     ::User.new ...
  #   end
  #
  #   convert.import_pages do |other_page|
  #     # build Publify Page object from other page
  #     ::Page.new ...
  #   end
  #
  #   convert.import_articles do |other_article|
  #     # build Publify Article object from other article
  #     ::Article.new ...
  #   end
  #
  #   convert.import_comments do |other_comment|
  #     # build Publify Comment object from other comment
  #     ::Comment.new ...
  #   end
  ...
  # Return the Publify filter None
  def filter
    @filter ||= ::TextFilter.find 1
  end

  # Returns all the users from the current Publify site, in a hash indexed by login name.
  def users
    @users        = ::User.find(:all)
