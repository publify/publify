Localization.define('ja_JP') do |l|
  ...
  l.store "Users", "ユーザー"
  l.store "Settings", "設定"
  l.store "Things you can do", "できること"
  l.store "with %s Famfamfam iconset %s", "%s 個のFamfamfamアイコン %s"

  #admin/login.rhtml
  l.store "Username", "ユーザー名"
  l.store "Password", "パスワード"
  l.store "Login", "ログイン"
  l.store "Back to the blog", "ブログに戻る"
  ...
  l.store "Category title", "カテゴリタイトル"
  l.store "Articles", "記事"
  ...
  l.store "Post title", "記事タイトル"
  l.store "Posted at", "投稿日"
  l.store "Comments", "コメント"
  l.store "Trackbacks", "トラックバック"
  l.store "View", "ビュー"
  l.store "Status", "ステータス"
  l.store "Offline", "オフライン"
  l.store "Online", "オンライン"
  l.store "no trackbacks", "トラックバックはありません"
  l.store "no comments", "コメントはありません"
  ...
  l.store "Article Body", "記事本文"
  l.store "Post", "記事"
  l.store "Optional extended content", "オプションの追加記事"
  l.store "Optional Extended Content", "オプションの追加記事"
  l.store "Article Content", "記事本文"
  l.store "Extended Content", "拡張記事"
  l.store "Tags", "タグ"
  l.store "Save", "保存"
  l.store "Article Attachments", "記事添付ファイル"
  l.store "Article Options", "記事オプション"
  ...
  l.store "Textfilter", "テキストフィルター"
  l.store "Toggle Extended Content", "拡張記事を切り換え"
  ...
  l.store "Limit to spam", "スパムの制限"
  l.store "Limit to unconfirmed", "未承認の制限"
  l.store "Limit to unconfirmed spam", "未承認スパムの制限"
  l.store "Blacklist", "ブラックリスト"
  l.store "Feedback Search", "フィードバックサーチ"
  l.store "Comments and Trackbacks for", "コメントとトラックバック"

  #admin/general/task
  l.store "Basic settings", "基本設定"
  l.store "Advanced settings", "拡張設定"
  l.store "Blog advanced settings", "ブログの拡張設定"

  #admin/general/index.rhtml
  l.store "Blog settings", "ブログ設定"
  l.store "Which settings group would you like to edit", "どの設定グループを編集しますか？"
  l.store "General settings", "一般設定"
  l.store "General Settings", "一般設定"
  l.store "Read", "読む"
  l.store "Write", "書く"
  l.store "Discuss", "フィードバック"
  l.store "Notification", "通知"
  l.store "Spam Protection", "スパムプロテクション"
  l.store "Resource Settings", "リソース設定"
  l.store "Cache", "キャッシュ"
  l.store "Blog name", "ブログ名"
  l.store "Blog subtitle", "ブログサブタイトル"
  l.store "Language", "言語"
  l.store "This option let you choose between the simple admin interface or the complete one, displaying much more options and therefore more complicated to use. For advanced users only!", "このオプションはシンプルな管理者画面か複雑なものか選択できます。編集可能な項目をよりたくさん表示しますが、使うには複雑になります。上級者のみ利用ください。"
  ...
  l.store "Save Settings", "設定保存"
  l.store "articles on my homepage by default", "ホームページディフォルトの記事"
  l.store "articles in my news feed by default", "ニュースフィードディフォルトの記事"
  l.store "Show full article on feed", "記事全文をフィードに表示"
  l.store "Article filter", "記事フィルター"
  l.store "Comments filter", "コメントフィルター"
  l.store "When publishing articles, Typo can send trackbacks to websites that you link to. This should be disabled for private blogs as it will leak non-public information to sites that you're discussing. For public blogs, there's no real point in disabling this.", "記事が公開されると、Typeはリンクしたページへトラックバックを送信します。非公開ブログの場合は公開されたブログへ情報が漏れないようにこのチェックボックスを非選択にしてください。公開ブログの場合は非選択にする必要はありません。"
  l.store "Send trackbacks", "トラックバック送信"
  l.store "URLs to ping automatically", "自動的にPingを送信するURL"
  l.store "This setting allows you to disable trackbacks for every article in your blog.  It won't remove existing trackbacks, but it will prevent any further attempt to add a trackback anywhere on your blog.", "この設定はすでにあるトラックバックを削除しませんが、あたらしく追加しようとするトラックバックを防ぐことができます。"
  l.store "Disable trackbacks site-wide" ,"サイト間のトラックバックを不可にする"
  l.store "Enable Trackbacks by default", "デェフォルトでトラックバックを許可する"
  l.store "You can enable site wide feeback moderation. If you do so, no comment or trackback will appear on your blog unless you validate it", "サイト全体のフィードバック管理を有効にすることができます。有効にするとコメントやトラックバックは許可するまで表示されません。"
  l.store "Enable feedback moderation", "フィードバック管理有効にする"
  l.store "Enable comments by default", "ディフォルトでコメントを有効にする"
  l.store "Show your email address", "emailアドレス表示"
  l.store "Enable gravatars", "アバターを有効にする"
  l.store "You can optionally disable non-Ajax comments. Typo will always use Ajax for comment submission if Javascript is enabled, so non-Ajax comments are either from spammers or users without Javascript.", "オプションでAjaxでないコメントを不許可にすることができます。Javascriptが有効な場合Typoはコメントの入力にAjaxを使います。つまりAjaxでないコメントはJavascriptを有効にしていないか、スパマーのどちらかです。"
  l.store "Allow non-ajax comments", "Ajaxでないコメントを許可する"
  l.store "Disable comments after", "以下のコメントを不許可にする"
  l.store "Set to 0 to never disable comments", "コメントを不許可にしない場合は0をセットしてください。"
  ...
  l.store "Set to 0 to never reject comments", "コメントを拒否しない場合は0をセットしてください。"
  l.store "Typo can notify you when new articles or comments are posted", "新しい記事やコメントが投稿された場合に通知を送ることができます"
  l.store "Source Email", "email"
  l.store "Email address used by Typo to send notifications", "通知を送る場合にしようするemailアドレス"
  l.store "Jabber account", "Jabberアカウント"
  l.store "Jabber account to use when sending Jabber notifications", "通知を送る場合に使用するJabberアカウント"
  l.store "Jabber password", "Jabberパスワード"
  l.store "Spam protection", "スパムプロテクション"
  l.store "Enabling spam protection will make typo compare the IP address of posters as well as the contents of their posts against local and remote blacklists. Good defense against spam bots", "スパムプロテクションを有効にすると、コンテンツ投稿者のIPアドレスをローカル、リモート両方のブラックリストと比較します。"
  l.store "Enable spam protection", "スパムプロテクションを有効"
  l.store "Typo can (optionally) use the %s spam-filtering service.  You need to register with Akismet and receive an API key before you can use their service.  If you have an Akismet key, enter it here", "Typoはオプションで&sスパムフィルタリングサーバーを使用できます。これらのサービスを使用するにはAkismetに登録し、APIキーを取得する必要があります。すでにAkismetキーをお持ちであればここに入力してください。"
  l.store "Akismet Key", "Akismetキー"
  l.store "The below settings act as defaults when you choose to publish an enclosure with iTunes metadata", "以下の設定はiTunesメタデータを含めて公開する場合にディフォルトとして設定されます"
  ...
  l.store "Copyright Information", "コピーライトインフォメーション"
  l.store "Explicit", "Explicit"
  l.store "Empty Fragment Cache", "フラグメントキャッシュを空にする"
  l.store "Rebuild cached HTML", "キャッシュHTMLを再構築する"
  l.store "There are %d entries in the cache", "キャッシュ内に%d個の記事があります"
  l.store "days", "日"

  #admin/general/update_database
  l.store "Database migration", "データベースミグレーション"
  ...
  l.store "Your database supports migrations", "あなたのデータベースはミグレーションをサポートしています"
  l.store "yes", "はい"
  l.store "no", "いいえ"
  l.store "Needed migrations", "ミグレーションが必要です"
  ...
  l.store "Page Body", "ページ本文"
  l.store "Page Content", "ページコンテント"
  l.store "Location", "ロケーション"
  l.store "Page Options", "ページオプション"
  ...
  l.store "Manage Text Filters", "テキストフィルターを管理"
  ...
  l.store "Upload a new File", "あたらしファイルをアップロード"
