...
Localization.define('es_MX') do |l|
  ...
  l.store "This option let you choose between the simple admin interface or the complete one, displaying much more options and therefore more complicated to use. For advanced users only!",
    "Esta opci&oacute;n te permite escoger entre la interfaz de administraci&oacute;n simple o avanzada, mostrando m&aacute;s opciones y por lo tanto m&aacute;s dif&iacute;cil de usar. S&oacute;lo para usuarios avanzados!"
  ...
  l.store "Drag and drop to change the sidebar items displayed on this blog.  To remove items from the sidebar just click remove  Changes are saved immediately, but not activated until you click the 'Publish' button",
    "Arrastra los items para cambiar el contenido de este blog. Para remover items de la barra lateral s&oacute;lo haz click en remover. Los cambios se guardan inmediatamente, pero no se activan hasta que hagas click en el bot&oacute;n 'Publicar'"
  ...
  l.store 'Anti-bot protection: How much is', 'Protecci&oacute;n anti-bot: Cu&acute;nto es'
  ...
  l.store "This comment has been flagged for moderator approval.  It won't appear on this blog until the author approves it",
    "Este comentario ha sido marcado para moderaci&oacute;n. No aparecer&aacute; hasta que el autor lo apruebe"
  l.store 'later', 'despu&eacute;s'
  ...
  l.store 'Back to overview', 'Regresar a la descripci&oacute;n'
  
  #views/shared/_search.rhtml
  l.store 'Live Search', 'B&uacute;squeda en vivo'
  ...
  l.store '1 day', '1 d&iacute;a'
  l.store '1 year', '1 a&ntilde;o'
  l.store '1 month', '1 mes'
  l.store 'day', 'd&iacute;a'
  l.store 'days', 'd&iacute;as'
  l.store 'month', 'mes'
  l.store 'months', 'meses'
  l.store 'year', 'a&ntilde;o'
  l.store 'years', 'a&ntilde;os'
  l.store 'over', 'm&aacute;s de'
  ...
  l.store 'js_days', 'js_d&iacute;as'
  l.store 'js_in', 'js_en'
  ...
  l.store 'js_one day', 'js_un d&iacute;a'
  l.store 'js_about one day', 'js_cerca de un d&iacute;'
